...
"""
openedx-session-time documentation build configuration file.
...
project = 'openedx-session-time'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'Session Time Tracker'
...
#
# html_title = 'openedx-session-time v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_session_time'),
                os.path.join(root_path, 'openedx_session_time/migrations')])
